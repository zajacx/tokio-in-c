...
int main()
{
    ...
    // These two futures are wrapped in SelectFuture.
    ...
    // Create a JoinFuture that executes two futures concurrently.
    SelectFuture f12 = future_select((Future*)&f1, (Future*)&f2);

    // Create and run executor.
    Executor* executor = executor_create(10);
    executor_spawn(executor, (Future*)&f12);
